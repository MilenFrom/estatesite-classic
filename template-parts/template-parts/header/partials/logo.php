	...
	<div class="logo logo-splash">
		<a href="<?php echo esc_url( $splash_logo_link ); ?>">
			<?php if( !empty( $splash_logo ) ) { ?>
				<img src="<?php echo esc_url( $splash_logo ); ?>" height="<?php echo esc_attr($logo_height); ?>" width="<?php echo esc_attr($logo_width); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>">
			<?php } ?>
		</a>
	</div>
<?php } else { ?>
	...
	<div class="logo logo-desktop">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
			<?php if( !empty( $custom_logo ) ) { ?>
				<img src="<?php echo esc_url( $custom_logo ); ?>" height="<?php echo esc_attr($logo_height); ?>" width="<?php echo esc_attr($logo_width); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>">
			<?php } ?>
		</a>
	</div>
<?php } ?>